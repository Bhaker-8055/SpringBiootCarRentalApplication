...
public class BookingService {
	...
	public boolean checkVehicleAvailability(Vehicle vehicle, LocalDate startDate, LocalDate endDate) {
		...
		if (bookingList.isEmpty()) {
			...
			for (Booking booking : bookingList) {
				...
				if (!availability) {
					System.out.println("-------------------------->"+startDateAvailability + endDateAvailability);
					break;
				}
			}
	...
	public boolean checkIfStartDateIsSameToEndDate(LocalDate startDate, LocalDate endDate) {
		System.out.println("---------------------->"+endDate.isEqual(startDate));
